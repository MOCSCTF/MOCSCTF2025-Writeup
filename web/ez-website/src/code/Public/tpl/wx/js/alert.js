...
window.jQuery(document).ready(function () { 
		window.jQuery("#windowclosebutton").click(function () { 
			window.jQuery("#windowcenter").slideUp(500);
		}); 
		window.jQuery("#alertclose").click(function () { 
			window.jQuery("#windowcenter").slideUp(500);
		}); 
}); 
function alert(title){ 
		...
		window.jQuery("#windowcenter").slideToggle("slow"); 
		window.jQuery("#txt").html(title);
		//$("#windowcenter").hide("slow"); 
		setTimeout('window.jQuery("#windowcenter").slideUp(500)', 5000);
} 
