...
class DbKingbase extends Db{
    ...
    public function last_insert_id() {
        try{
            ...
            $last_insert_id = isset($data['insert_id']) ? $data['insert_id'] : null;
    ...
    public function error($result = true) {
        $this->error = $result && $this->queryID ?pg_result_error($this->queryID): pg_last_error($this->_linkID);
